  ...
  <q-dialog v-model="opened" persistent>
    <q-card class="q-pa-md" style="min-width: 30vw">
      ...
      <q-scroll-area style="width: 400px; height: 375px;">
        <q-list bordered separator class="q-mt-sm q-body-1">
              ...
              <q-item-label>
                {{
                  propLeadInformation.leadCategory === 1
                    ...
                    ? 'Exception'
                    : propLeadInformation.leadCategory === 3
                    ? 'Aggregator'
                    : 'NA'
                }}
              </q-item-label>
          ...
          <q-item>
            <q-item-section>
              ...
              <q-item-label>
                {{
                  propLeadInformation.assignedTo
...
function fetchLeadInfo () {
  ...
  store.dispatch(
    ...
    props.leadInformation.leadId || props.leadInformation.id
  )
    .then(() => {
