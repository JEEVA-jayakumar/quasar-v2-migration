...
export default {
  ...
  setup(props, { emit }) {
    ...
    // Vuex actions
    const { REJECT_PHONEPE_LOST_STOLEN_EXCEPTION } = mapActions("LostFinance", [
      "REJECT_PHONEPE_LOST_STOLEN_EXCEPTION"
    ]);
    ...
    const financeRejectSubmit = () => {
      ...
      window.$q
        ...
        .onOk(() => {
          ...
          REJECT_PHONEPE_LOST_STOLEN_EXCEPTION(formData.regionalInventory)
            .then(() => {
