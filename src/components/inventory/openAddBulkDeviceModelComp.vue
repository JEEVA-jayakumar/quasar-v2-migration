        ...
        <div class="q-pa-md">
          <div class="row text-center justify-center">
            ...
            <div class="col-md-12 row justify-end q-mt-md">
              <q-btn outline color="dark" label="Cancel" @click="emitToggleInventoryBulkUpload" class="q-mr-sm"/>
...
const selectOption = ref(
  props.propAllDevicestypes.map(item => ({
...
watch(toggleModal, val => emit("closeModel", val));
...
const uploadFileForBulkUpload = () => {
  ...
  store.dispatch("InventoryBulkUploadDevice/FEED_DEVICE_BULK_UPLOAD_DATA", {
    file: payload,
