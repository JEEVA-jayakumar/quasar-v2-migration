...
const FETCH_SPARE_PARTS_POD_LIST_INVENTORY_DETAILS= ({
  commit
}, request) => {
...
const FETCH_PHONEPE_SPARE_PARTS_POD_LIST_INVENTORY_DETAILS= ({
  commit
}, request) => {
  console.log("API ACTION REQUEST DETAILS-------->",request)
  let sorting = request.pagination.descending ? 'asc' : 'desc';
...
export default {
  ...
  FETCH_PHONEPE_SPARE_PARTS_POD_LIST_INVENTORY_DETAILS
};
