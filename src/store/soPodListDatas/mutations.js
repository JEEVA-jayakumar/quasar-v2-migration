export const API_RESPONSE_LOG = (state, payload) => {
  ...
  SET_APPROVED_POD_LIST_DETAILS = (state, payload) => {
  console.log("ADDITIONAL TIDPayload : ------------ : " +  JSON.stringify(payload))
  state.approvedSoPodListDatas = payload;
},
SET_REJECTED_POD_LIST_DETAILS = (state, payload) => {
    console.log("ADDITIONAL TIDPayload : ------------ : " +  JSON.stringify(payload))
    state.rejectedSoPodListData = payload;
  },

  SET_PHONEPE_APPROVED_POD_LIST_DETAILS = (state, payload) => {
    console.log("ADDITIONAL TIDPayload : ------------ : " +  JSON.stringify(payload))
    state.PhonepeApprovedSoPodListDatas = payload;
  },

  SET_PHONEPE_REJECTED_POD_LIST_DETAILS = (state, payload) => {
    console.log("ADDITIONAL TIDPayload : ------------ : " +  JSON.stringify(payload))
