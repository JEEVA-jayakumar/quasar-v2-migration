...
export const FETCH_SERVICE_REQUEST_CANCELLED_DETAILS = ({commit}) => {
...
export const POST_CANCEL_STATUS_TYPES = (context, request) => {
...
// Remove unused commit parameter
export const EDIT_SERVICE_CANCEL_STATUS_TYPES = (context, request) => {
...
// Remove unused commit parameter
export const DELETE_SERVICE_CANCEL_STATUS_TYPES = (context, request) => {
  console.log('SUBMIT SERVICE_STATUS_TYPES request', JSON.stringify(request))
...
export const EDIT_CANCEL_STATUS_TYPES = (context, request) => {
  console.log("SUBMIT SERVICE_STATUS_TYPES request", JSON.stringify(request))
  return api.put("service-cancel/updateServiceCancelReason/" + request.id, request.request)
}