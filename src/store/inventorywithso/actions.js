...
export const FETCH_INVENTORY_WITH_SO = ({commit}) => {
...
export const FETCH_AGGREGATORS_INVENTORY_WITH_SO = ({commit}) => {
...
/*Aggregators API */
export const FETCH_INVENTORY_WITH_SO_BASED_ON_REGION = ({ commit }, request) => {
