...
export const CREATE_LS_VAS_DEVICE_CONFIG = (_, request) => {
  // Changed from _ to _ since commit is not used
  return api.post("ls-vas-mapping", request);
};

export const GET_LS_VAS_DEVICE_CONFIG_DETAILS = ({commit}) => {
...
export const UPDATE_LS_VAS_DEVICE_CONFIG_DETAILS = (_, request) => {
  // Changed from _ to _ since commit is not used
