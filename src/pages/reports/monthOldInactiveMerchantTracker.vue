...
export default {
  ...
  setup() {
    ...
    // Function to calculate start/end dates based on selected option
    const calculateDate = () => {
      const now = new Date();
    ...
    const downloadReport = async () => {
      ...
      try {
        await store.dispatch("reports/REPORT_INACTIVE_MERCHANT", formData.value);
