    ...
    <div class="backgroundimage">
      ...
      <div class="row bottom-border group q-px-md q-py-md items-center text-weight-regular text-grey-9">
        ...
        <div class="col-md-12 q-mt-md">
          <p class="caption text-weight-medium">Spare Parts Type*</p>
...
const toggleSparePart = (selected, menu) => {
  if (selected) {
    // Add spare part with default count of 0
    ...
    if (existingIndex === -1) {
      formData.sparePartsSets.push({
        ...
        spareParts: {
          id: menu.id,
          spare_parts_types: menu.spare_parts_types
        }
      });
    }
  } else {
...
const fnSubmitBankDetails = async () => {
  ...
  try {
    await store.dispatch("sparePartsInventory/CREATE_SPARE_POD_LIST_INVENTORY", requestData);
